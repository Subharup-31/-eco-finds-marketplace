      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center gap-2 font-bold text-xl text-card-foreground mb-4">
            ...
            <p className="text-muted-foreground mb-4 max-w-md">
              Building a sustainable future through conscious consumption. Join our community of eco-friendly shoppers
              and sellers.
            </p>
